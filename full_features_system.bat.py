...
"""
نظام إدارة السيارات الشامل - كامل الوظائف
    ...
    try:
        ...
        for emp in employees:
            ...
            <tr>
                ...
                <td>
                    <a href="{{ url_for('edit_employee', id={emp['id']}) }}" class="btn btn-sm btn-warning">تعديل</a>
                    <a href="{{ url_for('delete_employee', id={emp['id']}) }}" class="btn btn-sm btn-danger" onclick="return confirm('هل أنت متأكد من حذف هذا الموظف؟')">حذف</a>
                </td>
            </tr>
            """
...
# باقي الوظائف ستكون في الجزء التالي...
...
if __name__ == '__main__':
    ...
    print("   • إضافة وتعديل وحذف السيارات")
    print("   • إدارة الخزينة والمعاملات")
    print("   • إدارة المصروفات والعهد")
    print("   • بيانات التسليم والاستلام")
    print("   • تقارير شاملة ومفصلة")
